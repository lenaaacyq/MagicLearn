...
import { Flame, Wand2, Lock, BookOpen, Volume2 } from 'lucide-react';
...
function QuestCard({ title, subtitle, icon, status, glowColor, progress, onClick }: QuestCardProps) {
    ...
    >
      ...
      <div className="relative z-10 flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-lg font-semibold mb-1" style={{ fontFamily: 'var(--font-serif)' }}>
            {title}
          </h4>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-[var(--neon-gold)]">7</p>
                <p className="text-xs text-[var(--muted-foreground)]">天连胜</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold">大魔法师</p>
                <p className="text-xs text-[var(--muted-foreground)]">Grand Wizard</p>
              </div>
            </div>
          </div>
        </div>
